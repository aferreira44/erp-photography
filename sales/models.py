...
class Service(models.Model):
    ...
    description = models.CharField(verbose_name="Descrição", blank=True, null=True, max_length=200)
...
class Invoice(models.Model):
    ...
    name = models.CharField(verbose_name="Nome", max_length=200)
    description = models.CharField(verbose_name="Descrição", blank=True, null=True, max_length=200)
    status = models.CharField(max_length=50, choices=INVOICE_STATUSES, default=INVOICE_STATUSES[0])
