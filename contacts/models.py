...
class Client(models.Model):
    ...
    middle_name = models.CharField(verbose_name="Nome do meio", blank=True, null=True, max_length=200)
    ...
    address = models.ForeignKey(Address, verbose_name="Endereço", blank=True, null=True, on_delete=models.CASCADE)
